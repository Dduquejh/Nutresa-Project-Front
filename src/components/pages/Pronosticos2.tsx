...
const Pronosticos2: React.FC = () => {
  ...
  const handleUpdate = async () => {
    ...
    } else if (variable === "Consumo de café") {
      try {
        setLoading(true); // Empieza a cargar
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="bg-white p-6 rounded-md shadow-md">
        <h1 className="text-3xl font-bold mb-4 text-black">Pronósticos</h1>
        <p className="text-lg mb-6 text-gray-700">
          Seleccione los pronósticos generados de la lista de pronósticos que se
          despliegan a continuación
        </p>

        {/* Filtro para el pronóstico */}
        <h2 className="text-xl font-semibold mb-4 text-black">
          Seleccione el pronóstico que desea visualizar
        </h2>
